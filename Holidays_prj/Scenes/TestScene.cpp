...
void TestScene::OnEnter()
{
    ...
    // --- 천장 (Top Wall) 생성 ---
    ATerrain* TopWall = new ATerrain(EResourceID::Tileset, EBlockType::Solid);
    ...
    // --- 바닥 (Bottom Wall) 생성 ---
    ATerrain* BottomWall = new ATerrain(EResourceID::Tileset, EBlockType::Solid);
    ...
    // --- 왼쪽 벽 (Left Wall) 생성 ---
    ATerrain* LeftWall = new ATerrain(EResourceID::Tileset, EBlockType::Solid);
    ...
    // --- 오른쪽 벽 (Right Wall) 생성 ---
    ATerrain* RightWall = new ATerrain(EResourceID::Tileset, EBlockType::Solid);
    ...
    // 1. 왼쪽 하단 플랫폼
    ATerrain* OneWayPlatform1 = new ATerrain(EResourceID::Tileset, EBlockType::OneWay);
    ...
    // 2. 중앙 중간 플랫폼
    ATerrain* OneWayPlatform2 = new ATerrain(EResourceID::Tileset, EBlockType::OneWay);
    ...
    // 3. 오른쪽 상단 플랫폼
    ATerrain* OneWayPlatform3 = new ATerrain(EResourceID::Tileset, EBlockType::OneWay);
    ...
    // 4. 좀 더 긴 중앙 플랫폼
    ATerrain* OneWayPlatform4 = new ATerrain(EResourceID::Tileset, EBlockType::OneWay);
